...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'save_supplier') {
        ...
        $credentials = [];
        foreach (['username', 'password', 'token', 'api_key', 'api_key_header', 'graphql_query', 'access_token'] as $c) {
...
$shippingRules = $id ? supplier_shipping_rules_list($id) : [];
...
<div class="card" id="versand">
    ...
    <div class="card-body">
        ...
        <div class="table-wrap" style="margin-bottom:1.5rem;">
            <table class="table">
                <thead><tr><th>Typ</th><th>Bedingung</th><th>Betrag</th><th>Priorität</th><th class="col-actions">Aktionen</th></tr></thead>
                <tbody>
