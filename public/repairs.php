...
if ($q !== '') {
    $like = '%' . $q . '%';
    $where_parts[] = '(r.repair_number LIKE ? OR CONCAT(c.first_name," ",c.last_name) LIKE ? OR r.manufacturer LIKE ? OR r.model LIKE ?)';
                        ...
                        <?php foreach ($repairs as $r): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php endif; ?>
                                    <br>
                                    <small class="text-muted"><?= h($r['device_type'] ?? '') ?></small>
                                </td>
                                <td>
                                ...
                                <td class="text-right">
                                    <?= $r['price'] !== null ? h(fmt_money((float)$r['price'])) : '<span class="text-muted">—</span>' ?>
                                </td>
                                <td>
