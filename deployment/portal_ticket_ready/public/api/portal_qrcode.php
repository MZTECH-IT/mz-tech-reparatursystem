...
// Gehashte Zugangstokens können absichtlich nicht aus der Datenbank
// rekonstruiert werden. Neue Links werden ausschließlich per CSRF-
// geschützter POST-Aktion in customers_form.php erzeugt und einmal gezeigt.
http_response_code(410);
header('Content-Type: text/plain; charset=UTF-8');
header('Cache-Control: no-store');
echo 'QR-Code-Abruf deaktiviert: Bitte einen neuen Portal-Link in der Kundenverwaltung erzeugen.';
exit;
