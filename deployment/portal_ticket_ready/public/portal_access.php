...
$companyAccounts = $db->query(
    'SELECT cc.id, cc.email, cc.first_name, cc.last_name, cc.portal_role,
            cc.is_verified, cc.is_active, cc.last_login_at, c.company_name
...
<?php
$sections = [
    'Kundenkonten' => [$customerAccounts, ['Name','E-Mail','Verifiziert','Aktiv','Letzter Login']],
    'Firmenkonten' => [$companyAccounts, ['Firma','Name','E-Mail','Rolle','Verifiziert','Aktiv']],
];
