    ...
    <div class="card-body">
        ...
        <div class="table-wrap">
            <table class="table">
                <thead>
                    <tr>
                        <th>Lieferant</th><th>Lief.-SKU</th><th class="text-right">EK-Preis</th><th>Währung</th>
                        <th>Verfügbarkeit</th><th class="text-right">Lieferzeit</th><th class="text-right">Versand (Schätzung)</th>
                        <th class="text-right">Mindestmenge</th><th>Verpackungseinheit</th><th>Letzte Sync.</th>
                ...
                <?php foreach ($offers as $o): ?>
                    <tr <?= $o['is_flagged_faulty'] ? 'style="background:rgba(220,38,38,.06);"' : '' ?>>
                        ...
                        <td class="text-right"><?= $o['minimum_order_quantity'] !== null ? (int)$o['minimum_order_quantity'] : '—' ?></td>
                        <td><?= h($o['packaging_unit'] ?? '—') ?></td>
