...
function portal_email_delivery_enabled(): bool {
    if (get_setting('portal_email_delivery_enabled', '0') !== '1') return false;
    return function_exists('smtp_configuration_status')
        && !empty(smtp_configuration_status()['configured']);
}
