...
<div class="app-shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="<?= url('payments.php') ?>" class="nav-item <?= $current_page==='payments'?'active':'' ?>">
        <?= svg_icon('euro') ?> Zahlungen
      </a>
      <?php endif; ?>
      ...
      <a href="<?= url('portal_access.php') ?>" class="nav-item <?= $current_page==='portal_access'?'active':'' ?>">
        ...
        <?php $pendingPortalAccounts = portal_pending_account_count(); ?>
        <?php if ($pendingPortalAccounts > 0): ?>
          <span class="badge-red" style="margin-left:auto;"><?= $pendingPortalAccounts ?></span>
        <?php endif; ?>
      </a>
      <?php endif; ?>
      <?php endif; ?>
      ...
      <a href="<?= url('device_types.php') ?>" class="nav-item <?= $current_page==='device_types'?'active':'' ?>">
        <?= svg_icon('list') ?> Gerätearten
      </a>
