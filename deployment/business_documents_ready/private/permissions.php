...
const PERMISSION_DEFINITIONS = [
    ...
    // Phase 7 - Buchhaltungsintegration (lexoffice/sevDesk/DATEV). Eigene,
    // grobgranulare Berechtigung analog zu manage_suppliers: Zugangsdaten
    // und Synchronisation externer Buchhaltungssysteme sind sensibel genug,
    // um nicht implizit an eine bestehende Berechtigung gekoppelt zu sein.
    'manage_accounting'      => ['label' => 'Buchhaltungsintegration verwalten',   'category' => 'Finanzen'],
    'manage_payments'        => ['label' => 'Zahlungen und Anzahlungen erfassen',   'category' => 'Finanzen'],
];
